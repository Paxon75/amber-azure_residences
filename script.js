document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        ...
        de: {
            ...
            privacyS7Title: '§7 Przekazywanie Danych Poza Europejski Obszar Gospodarczy (EOG)',
            privacyS7P1: 'W związku z korzystaniem przez Administratora z usług podmiotów takich jak GitHub, Inc. oraz Meta Platforms, Inc. (WhatsApp, Messenger), Twoje dane osobowe mogą być przekazywane do państw trzecich, w szczególności do Stanów Zjednoczonych Ameryki (USA).',
            privacyS7P2: 'Przekazywanie danych odbywa się na podstawie mechanizmów zgodnych z RODO, przede wszystkim z wykorzystaniem standardowych klauzul umownych (SCC) zatwierdzonych przez Komisję Europejską, które zapewniają odpowiedni poziom ochrony Your personal data.',
            privacyS8Title: '§8 Final Provisions',
            privacyS8P1: 'The Administrator zastrzega sobie prawo do wprowadzania zmian w niniejszej Polityce Prywatności. Zmiany mogą być podyktowane rozwojem technologii, zmianami w przepisach prawa lub rozwojem Serwisu.',
            privacyS8P2: 'O wszelkich zmianach będziemy informować poprzez opublikowanie nowej wersji Polityki w Serwisie.',
            privacyS8P3: 'Niniejsza Polityka obowiązuje od dnia 16.07.2025 r.',
        }
    };
    ...
    const setLanguage = (lang) => {
        ...
        translatableElements.forEach(element => {
            ...
            // Sprawdź, czy element jest inputem, aby nie zmieniać jego wartości, tylko placeholder
