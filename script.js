document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        pl: {
            ...
            testimonialsSubtitle: 'Twoje wspomnienia są dla nas najważniejsze. Zobacz, jak oceniają nas goście, którzy już odkryli magię Amber & Azure.',
            testimonialAuthor1: 'Anna i Tomasz',
            testimonialDate1: 'Pobyt w lipcu 2024',
            testimonialText1: '"Niezapomniany pobyt! Apartament Azure to kwintesencja luksusu i komfortu. Czysto, nowocześnie, a taras z widokiem na las to absolutny hit. Wrócimy na pewno!"',
            testimonialAuthor2: 'Karolina z rodziną',
            testimonialDate2: 'Pobyt w sierpniu 2024',
            testimonialText2: '"Idealne miejsce na wypoczynek z dziećmi. Bliskość natury, dostęp do basenów i placu zabaw. Sam apartament przepięknie urządzony i w pełni wyposażony. Polecamy z całego serca."',
            // Kontakt i stopka
        ...
        en: {
            ...
            testimonialsSubtitle: 'Your memories are most important to us. See how guests who have already discovered the magic of Amber & Azure rate us.',
            testimonialAuthor1: 'Anna & Tomasz',
            testimonialDate1: 'Stayed in July 2024',
            testimonialText1: '"An unforgettable stay! The Azure apartment is the quintessence of luxury and comfort. Clean, modern, and the terrace with a forest view is an absolute hit. We will definitely be back!"',
            testimonialAuthor2: 'Karolina & family',
            testimonialDate2: 'Stayed in August 2024',
            testimonialText2: '"The perfect place for a holiday with children. Proximity to nature, access to pools and a playground. The apartment itself is beautifully decorated and fully equipped. We recommend it with all our hearts."',
            // Contact & Footer
        ...
        de: {
            ...
            testimonialsSubtitle: 'Ihre Erinnerungen sind uns am wichtigsten. Sehen Sie, wie uns Gäste bewerten, die die Magie von Amber & Azure bereits entdeckt haben.',
            testimonialAuthor1: 'Anna & Tomasz',
            testimonialDate1: 'Aufenthalt im Juli 2024',
            testimonialText1: '"Ein unvergesslicher Aufenthalt! Das Azure-Apartment ist der Inbegriff von Luxus und Komfort. Sauber, modern und die Terrasse mit Waldblick ist ein absolutes Highlight. Wir kommen auf jeden Fall wieder!"',
            testimonialAuthor2: 'Karolina & Familie',
            testimonialDate2: 'Aufenthalt im August 2024',
            testimonialText2: '"Der perfekte Ort für einen Urlaub mit Kindern. Die Nähe zur Natur, der Zugang zu den Pools und zum Spielplatz. Das Apartment selbst ist wunderschön eingerichtet und voll ausgestattet. Wir empfehlen es von ganzem Herzen."',
            // Contact & Footer
