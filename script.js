document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        pl: {
            ...
            apartmentsMainSubtitle: 'Każdy z naszych apartamentów to unikalna historia opowiedziana przez design, komfort i bliskość natury. Wybierz swoją idealną przestrzeń do relaksu.',
            amberTitle: 'Apartament Amber Suite',
            amberDesc: 'Wejdź do świata ciepła i elegancji. Apartament Amber Suite o powierzchni 37 m² został zaprojektowany z myślą o Gościach ceniących sobie przytulny luksus. Jego wystrój sprzyja relaksowi i tworzy atmosferę domowego ciepła w luksusowym wydaniu.',
            amberDetail1: '<b>Salon:</b> Wygodna, rozkładana sofa dwuosobowa, nowoczesny telewizor i stylowa, duża ława.',
            amberDetail2: '<b>Aneks Kuchenny:</b> W pełni wyposażony (zmywarka, lodówka, płyta, mikrofalówka, toster, czajnik) z elegancką wyspą kuchenną i hokerami.',
            amberDetail3: '<b>Sypialnia:</b> Oaza spokoju z podwójnym łóżkiem (160x200 cm), osobnym telewizorem i pojemną szafą.',
            amberDetail4: '<b>Taras:</b> Ogromny, 15-metrowy taras z widokiem na Woliński Park Narodowy, dostępny z obu pokoi.',
            amberDetail5: '<b>Klimatyzacja:</b> Pełen komfort termiczny dzięki klimatyzacji w salonie i sypialni.',
            azureTitle: 'Apartament Azure Suite',
            azureDesc: 'Apartament Azure Suite, również o powierzchni 37 m², to propozycja dla tych, którzy cenią sobie klasyczną elegancję połączoną z nowoczesną funkcjonalnością. To przestrzeń, która otula i pozwala w pełni cieszyć się każdą chwilą pobytu.',
            azureDetail1: '<b>Salon:</b> Zaprasza do wypoczynku na komfortowej, rozkładanej sofie dwuosobowej, z nowoczesnym telewizorem i eleganckim stolikiem kawowym.',
            azureDetail2: '<b>Aneks Kuchenny:</b> Funkcjonalność i niezależność dzięki płycie elektrycznej, zmywarce, lodówce, mikrofalówce i pełnemu wyposażeniu.',
            azureDetail3: '<b>Część jadalniana:</b> Piękny, okrągły stół z krzesłami tworzy przytulny kącik do wspólnych posiłków.',
            azureDetail4: '<b>Sypialnia:</b> Luksusowe, podwójne łóżko (160x200 cm), osobny telewizor i pojemna szafa gwarantują idealny sen.',
            azureDetail5: '<b>Taras:</b> Imponujący, 15-metrowy taras z widokiem na las, dostępny z salonu i sypialni.',
            azureDetail6: '<b>Klimatyzacja:</b> Indywidualnie sterowana w obu pomieszczeniach dla Twojego komfortu.',
        ...
        en: {
            ...
            amberDesc: 'Step into a world of warmth and elegance. The 37 m² Amber Suite has been designed for guests who appreciate cozy luxury. Its decor promotes relaxation and creates an atmosphere of home-like warmth.',
            ...
            azureDesc: 'A proposal for those who value classic elegance combined with modern functionality. The 37 m² Azure apartment is a space that envelops and allows you to fully enjoy every moment of your stay.',
        ...
        de: {
            ...
            amberTitle: 'Amber Suite Apartment',
            amberDesc: 'Treten Sie ein in eine Welt der Wärme und Eleganz. Das 37 m² große Amber Suite wurde für Gäste entworfen, die gemütlichen Luxus schätzen. Seine Einrichtung fördert die Entspannung und schafft eine Atmosphäre von häuslicher Wärme.',
            ...
            azureTitle: 'Azure Suite Apartment',
            azureDesc: 'Ein Vorschlag für diejenigen, die klassische Eleganz in Verbindung mit moderner Funktionalität schätzen. Das 37 m² große Azure-Apartment ist ein Raum, der Sie umhüllt und Sie jeden Moment Ihres Aufenthalts genießen lässt.',
